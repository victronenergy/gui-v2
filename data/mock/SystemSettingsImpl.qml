...
QtObject {
	...
	Component.onCompleted: {
		...
		setMockSettingValue("Gui2/BriefView/Level/0", "" + VenusOS.Tank_Type_Fuel)
		setMockSettingValue("Gui2/BriefView/Level/1", "mock/com.victronenergy.tank.ttyUSB0")
		setMockSettingValue("Gui2/BriefView/Level/2", "" + VenusOS.Tank_Type_Battery)
		setMockSettingValue("Gui2/BriefView/Level/3", "com.victronenergy.battery/1:1")
