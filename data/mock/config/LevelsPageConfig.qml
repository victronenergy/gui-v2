	...
	property var tankConfigs: [
		{
			...
			tanks: [
				{ type: Enums.Tank_Type_Fuel, level: 100, capacity: 1.1 },
				{ type: Enums.Tank_Type_Fuel, level: 75, capacity: 1 },
				{ type: Enums.Tank_Type_Fuel, level: 20, capacity: 1 },
				{ type: Enums.Tank_Type_Fuel, level: 10, capacity: 1 },
				{ type: Enums.Tank_Type_Fuel, level: 0, capacity: 1 },
			]
		},
		{
			name: "Check BlackWater colors (different from Fuel level colors)",
			tanks: [
				{ type: Enums.Tank_Type_BlackWater, level: 100, capacity: 1 },
				{ type: Enums.Tank_Type_BlackWater, level: 90, capacity: 1 },
				{ type: Enums.Tank_Type_BlackWater, level: 85, capacity: 1 },
				{ type: Enums.Tank_Type_BlackWater, level: 75, capacity: 1 },
				{ type: Enums.Tank_Type_BlackWater, level: 0, capacity: 1 },
			]
		},
		{
			name: "1 tank",
			tanks: [
				{ type: Enums.Tank_Type_Fuel, level: 46.34, capacity: 1 },
			],
		},
		{
			name: "2 tanks",
			tanks: [
				{ type: Enums.Tank_Type_Fuel, level: 46.34, capacity: 1 },
				{ type: Enums.Tank_Type_FreshWater, level: 50, capacity: 2 },
			],
		},
		{
			name: "3 tanks (two of same type)",
			tanks: [
				{ type: Enums.Tank_Type_Fuel, level: 16.34, capacity: 1 },
				{ type: Enums.Tank_Type_Fuel, level: 75.334, capacity: 1 },
				{ type: Enums.Tank_Type_FreshWater, level: 10, capacity: 2 },
			]
		},
		{
			...
			tanks: [
				...
				{ type: Enums.Tank_Type_Fuel, level: 75.334, capacity: 1 },
				{ type: Enums.Tank_Type_FreshWater, level: 10, capacity: 2 },
				{ type: Enums.Tank_Type_BlackWater, level: 25, capacity: .2 },
			]
		},
		{
			...
			tanks: [
				...
				{ type: Enums.Tank_Type_Fuel, level: 75.334, capacity: 1 },
				{ type: Enums.Tank_Type_FreshWater, level: 10, capacity: 2 },
				{ type: Enums.Tank_Type_WasteWater, level: 75, capacity: 1 },
				{ type: Enums.Tank_Type_BlackWater, level: 25, capacity: .2 },
			]
		},
		{
			...
			tanks: [
				...
				{ type: Enums.Tank_Type_FreshWater, level: 10, capacity: 2 },
				{ type: Enums.Tank_Type_WasteWater, level: 75, capacity: 1 },
				{ type: Enums.Tank_Type_Oil, level: 80.2, capacity: .1 },
				{ type: Enums.Tank_Type_BlackWater, level: 25, capacity: .2 },
			]
		},
		{
			...
			tanks: [
				...
				{ type: Enums.Tank_Type_FreshWater, level: 50, capacity: 2 },
				{ type: Enums.Tank_Type_Fuel, level: 75.334, capacity: 1 },
				{ type: Enums.Tank_Type_LiveWell, level: 20, capacity: 1 },
				{ type: Enums.Tank_Type_Oil, level: 80.2, capacity: .1 },
				{ type: Enums.Tank_Type_BlackWater, level: 25, capacity: .2 },
			]
		},
		{
			...
			tanks: [
				...
				{ type: Enums.Tank_Type_Oil, level: 80.2, capacity: .1 },
				{ type: Enums.Tank_Type_BlackWater, level: 25, capacity: .2 },
				{ type: Enums.Tank_Type_BlackWater, level: 50, capacity: .2 },
				{ type: Enums.Tank_Type_BlackWater, level: 75, capacity: .2 },
			]
		},
		{
			...
			tanks: [
				...
				{ type: Enums.Tank_Type_Fuel, level: 75.334, capacity: 1 },
				{ type: Enums.Tank_Type_FreshWater, level: 10, capacity: 2 },
				{ type: Enums.Tank_Type_WasteWater, level: 75.334, capacity: 1 },
				{ type: Enums.Tank_Type_WasteWater, level: 75.334, capacity: 1 },
				{ type: Enums.Tank_Type_LiveWell, level: 20, capacity: 1 },
				{ type: Enums.Tank_Type_Oil, level: 80.2, capacity: .1 },
				{ type: Enums.Tank_Type_BlackWater, level: 25, capacity: .2 },
				{ type: Enums.Tank_Type_Gasoline, level: 75, capacity: .2 },
			]
		},
		{
			...
			tanks: [
				...
				{ type: Enums.Tank_Type_BlackWater, level: 25, capacity: .2 },
				{ type: Enums.Tank_Type_Gasoline, level: 75, capacity: .2 },
				{ type: Enums.Tank_Type_Diesel, level: 75, capacity: .25 },
				{ type: Enums.Tank_Type_LPG, level: 80, capacity: .3 },
				{ type: Enums.Tank_Type_LNG, level: 85, capacity: .4 },
				{ type: Enums.Tank_Type_HydraulicOil, level: 90, capacity: .5 },
				{ type: Enums.Tank_Type_RawWater, level: 95, capacity: .6 },
			]
		},
	]
