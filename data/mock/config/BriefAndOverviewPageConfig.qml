	...
	readonly property var configs: [
		{
			...
			acInputs: { type: Enums.AcInputs_InputType_Grid, phaseCount: 3, connected: true },
		...
		// TODO "ESS - AC & DC coupled. PV Inverter on AC Out (Amps version)",
		{
			...
			acInputs: { type: Enums.AcInputs_InputType_Generator, phaseCount: 3, connected: true },
			solar: { chargers: [ { power: 300 } ], inverters: [ { power: 1000 } ] },
		...
		{
			name: "Off grid",
			acInputs: { type: Enums.AcInputs_InputType_Generator, phaseCount: 3, connected: false },
			solar: { chargers: [ { power: 300 } ], inverters: [ { power: 1000 } ] },
			system: { state: Enums.System_State_AbsorptionCharging, ac: {}, dc: {} },
		...
		},
		{
			...
			acInputs: { type: Enums.AcInputs_InputType_Grid, phaseCount: 1, connected: true },
		...
		},
		{
			...
			acInputs: { type: Enums.AcInputs_InputType_Shore, phaseCount: 3, connected: true },
		...
		},
		{
			...
			acInputs: { type: Enums.AcInputs_InputType_Shore, phaseCount: 1, connected: true },
			system: { state: Enums.System_State_AbsorptionCharging, ac: {}, dc: {} },
		},
		{
		...
		},
		{
			...
			acInputs: { type: Enums.AcInputs_InputType_Grid, phaseCount: 1, connected: true },
			system: { state: Enums.System_State_FloatCharging, ac: {}, dc: {} },
			battery: { stateOfCharge: 100, current: 0 },
			evcs: { chargers: [ { status: Enums.Evcs_Status_Charging, mode: Enums.Evcs_Mode_Auto } ] }
		},
		{
			...
			system: { state: Enums.System_State_FloatCharging, ac: {} },
			battery: { stateOfCharge: 100, current: 0 },
			evcs: { chargers: [ { status: Enums.Evcs_Status_Charging }, { status: Enums.Evcs_Status_Charging }, { status: Enums.Evcs_Status_Disconnected } ] },
		},
		{
