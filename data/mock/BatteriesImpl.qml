...
QtObject {
	...
	function initLynxBattery(battery) {
		const props = {
			...
			"/System/NrOfModulesOffline": 1,
			"/System/NrOfModulesBlockingCharge": 1,
			"/System/NrOfModulesBlockingDischarge": 0,
			"/System/MinCellVoltage": 2.8,
			"/System/MaxCellVoltage": 4.2,
			"/System/MinCellTemperature": -20,
			"/System/MaxCellTemperature": 65,
			"/System/MinVoltageCellId": 1,
			"/System/MaxVoltageCellId": 2,
			"/System/MinTemperatureCellId": 3,
			"/System/MaxTemperatureCellId": 4,
			"/Connected": 1,
			"/ConsumedAmphours": 10,
