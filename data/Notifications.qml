...
QtObject {
	...
	readonly property int unacknowledgedNotificationCount: alarms.unacknowledgedCount +
	...
	readonly property bool hasUnAcknowledgedNotifications: alarms.hasUnAcknowledged ||
														   warnings.hasUnAcknowledged ||
														   informations.hasUnAcknowledged

	readonly property bool navBarNotificationCounterVisible: unacknowledgedModel.count > 0

	readonly property int statusBarNotifcationIconPriority: alarms.hasActive || !alarms.hasActive && alarms.hasUnAcknowledged ? VenusOS.Notification_Alarm :
