...
Item {
	...
	property int category: Enums.ToastNotification_Category_None
	...
	Rectangle {
		...
		color: root.category === Enums.ToastNotification_Category_None ? Theme.color.toastNotification.background.none
			 : root.category === Enums.ToastNotification_Category_Informative ? Theme.color.toastNotification.background.informative
			 : root.category === Enums.ToastNotification_Category_Confirmation ? Theme.color.toastNotification.background.confirmation
			 : root.category === Enums.ToastNotification_Category_Warning ? Theme.color.toastNotification.background.warning
		...
		AsymmetricRoundedRectangle {
			...
			color: root.category === Enums.ToastNotification_Category_Informative ? Theme.color.toastNotification.highlight.informative
				 : root.category === Enums.ToastNotification_Category_Confirmation ? Theme.color.toastNotification.highlight.confirmation
				 : root.category === Enums.ToastNotification_Category_Warning ? Theme.color.toastNotification.highlight.warning
			...
			CP.IconImage {
				...
				source: root.category === Enums.ToastNotification_Category_None ? ""
					  : root.category === Enums.ToastNotification_Category_Informative ? "qrc:/images/toast_icon_info.svg"
					  : root.category === Enums.ToastNotification_Category_Confirmation ? "qrc:/images/toast_icon_checkmark.svg"
