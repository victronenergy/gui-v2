...
Item {
	...
	Behavior on opacity { OpacityAnimator { duration: Theme.animation.toastNotification.fade.duration; onRunningChanged: console.log("ToastNotification: animator running:", running) } }
