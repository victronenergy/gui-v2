...
FocusScope {
	...
	RowLayout {
		...
		StatusBarButton {
			...
			visible: !breadcrumbs.visible
				&& ((!root.pageStack.opened && Global.switches.groups.count > 0)
			...
			enabled: controlCardsButton.buttonType !== VenusOS.StatusBar_LeftButton_ControlsActive
