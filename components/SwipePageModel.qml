...
ObjectModel {
	...
	readonly property list<SwipeViewPage> pages
		: showBoatPage && showLevelsPage ? [ boatPage, briefPage, overviewPage, levelsPage, notificationsPage, settingsPage ]
		: showBoatPage ? [ boatPage, briefPage, overviewPage, notificationsPage, settingsPage ]
		: showLevelsPage ? [ briefPage, overviewPage, levelsPage, notificationsPage, settingsPage ]
