...
T.Slider {
	...
	leftPadding: textMetrics.width + (Theme.geometry_dimmingSlider_text_padding * 2) + Theme.geometry_dimmingSlider_separator_width
	...
	background: Rectangle {
		...
		Label {
			...
			text: root.state ? CommonWords.on : CommonWords.off
		...
		SliderHandleHighlight {
			...
			width: root.handle.height - (Theme.geometry_switch_groove_border_width * 2)
	...
	handle: Rectangle {
		...
		Rectangle {
			...
			visible: !handleHighlight.visible
		}
	}
