...
T.Slider {
	...
	leftPadding: leftLabelTextMetrics.tightBoundingRect.x + leftLabelTextMetrics.tightBoundingRect.width + (Theme.geometry_temperatureSlider_text_horizontal_padding * 2)
	rightPadding: rightLabelTextMetrics.tightBoundingRect.x + rightLabelTextMetrics.tightBoundingRect.width + (Theme.geometry_temperatureSlider_text_horizontal_padding * 2)
	...
	onPressedChanged: {
		if (pressed && !Global.keyNavigationEnabled) {
			popup.open()
		} else {
			popup.close()
		}
	...
	Popup {
		...
		width: Math.max(Theme.geometry_temperatureSlider_popup_width,
			popupTextMetrics.tightBoundingRect.x + popupTextMetrics.tightBoundingRect.width + Theme.geometry_temperatureSlider_popup_padding)
	...
	TextMetrics {
		id: rightLabelTextMetrics
		font.family: Global.fontFamily
		font.pixelSize: Theme.font_size_body1
		text: rightPaddingText.text
	}
	TextMetrics {
		id: leftLabelTextMetrics
		font.family: Global.fontFamily
		font.pixelSize: Theme.font_size_body1
		text: leftPaddingText.text
	}
}
