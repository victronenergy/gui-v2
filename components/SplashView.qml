...
Rectangle {
	...
	Loader {
		...
		active: Global.dataManagerLoaded && onboardingState.isValid
				&& ( (Qt.platform.os === "wasm" && !(onboardingState.value & VenusOS.OnboardingState_CompletedOnWasm))
				  || (Qt.platform.os !== "wasm" && !(onboardingState.value & VenusOS.OnboardingState_CompletedOnDevice)) )
		anchors.fill: parent
