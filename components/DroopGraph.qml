...
Item {
    ...
    property alias xAxisReferenceUnit: xAxisReferenceQuantityLabel.unit
    property alias xAxisOperationValue: xAxisOperationQuantityLabel.value
    property alias xAxisOperationUnit: xAxisOperationQuantityLabel.unit
    property real xAxisLowerReferenceValue
    property real xAxisHigherReferenceValue
    ...
    property real yAxisHigherReferenceValue
    ...
    property real _indicatorRatie: 0.5

    property point _indicator: Qt.point(_droopLineMin.x + (_droopLineMax.x - _droopLineMin.x) * _indicatorPercent,
                                        _droopLineMin.y + (_droopLineMax.y - _droopLineMin.y) * _indicatorPercent)
