...
const briefCentralGauges = [V.Enums.Tank_Type_Battery].concat(V.Global.tanks.tankTypes)
...
function tankProperties(type) {
	switch (type) {
	case V.Enums.Tank_Type_Battery:
		return {
	...
	case V.Enums.Tank_Type_HydraulicOil:
		return {
	...
	case V.Enums.Tank_Type_RawWater:
		return {
