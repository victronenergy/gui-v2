...
Item {
	...
	states: [
		...
		//
		//  - When a text field is focused, shrink the view height to allow the user to see content
		//    at the bottom of the view that would otherwise be hidden by the VKB, and if needed,
		//    also scroll the contentY to bring the field into view.
		//
		//  - When focus is lost, restore the previous view height, but do not restore the contentY
		//    as this makes the view visually jumpy, and also if the user has scrolled the view to a
		//    new contentY this would moves the user's view away from the preferred position.
		State {
