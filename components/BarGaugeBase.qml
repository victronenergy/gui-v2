...
Rectangle {
	...
	implicitWidth: orientation === Qt.Vertical ? Theme.geometry_barGauge_vertical_width_large : parent.width
	implicitHeight: orientation === Qt.Vertical ? parent.height : Theme.geometry_barGauge_horizontal_height
