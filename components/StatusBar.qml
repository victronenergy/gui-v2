...
FocusScope {
	...
	Row {
		...
		CP.IconImage {
			...
			anchors.verticalCenter: parent.verticalCenter
			visible: Global.notifications?.statusBarNotifcationIconVisible ?? false
	...
	NotificationButton {
		...
		enabled: notificationButtonsEnabled && (Global.notifications?.hasUnacknowledgedNotifications ?? false)
