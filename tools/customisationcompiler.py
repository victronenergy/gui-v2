...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--name', required=True, help='The name of your customisation')
    parser.add_argument('-v', '--version', default='1.0', help='The version of your customisation')
    parser.add_argument('-z', '--minrequiredversion', default='', help='The minimum gui-v2 version required for the customisation')
    parser.add_argument('-x', '--maxrequiredversion', default='', help='The maximum gui-v2 version compatible with this customisation')
    parser.add_argument('-s', '--settings', default='', help='The main settings page .qml associated with your customisation')
    ...
    write_compiled_json(args.name, args.version, args.minrequiredversion, args.maxrequiredversion, translations, integrations, resource)
