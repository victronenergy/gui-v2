...
Item {
	...
	property real cropLineX: width / 2 // initial position; binding is overwritten when line is dragged
	...
	Rectangle {
		...
		RowLayout {
			...
			RowLayout {
				...
				spacing: 8
				visible: root.resultStatus === CompareModel.ResultReady && !root.imagesIdentical
	...
	Rectangle {
		...
		Flickable {
			...
			Item {
				...
				Loader {
					active: root.comparisonMode > 0 && root.resultStatus === CompareModel.ResultReady && !root.imagesIdentical
	...
	Rectangle {
		...
		color: "orange"
		radius: 4
		visible: root.resultStatus !== CompareModel.ResultPending && !root.bothImagesExist
	...
	Component {
		...
		Item {
			...
			Rectangle {
				...
				color: "#00BCD4"
				visible: cropLineCheckBox.checked && root.resultStatus === CompareModel.ResultReady && !root.imagesIdentical
