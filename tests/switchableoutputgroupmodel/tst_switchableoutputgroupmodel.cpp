...
int main(int argc, char **argv) \
{
    ...
    qmlRegisterUncreatableType<Victron::VenusOS::SwitchableOutputGroup>("Victron.VenusOS", 2, 0, "SwitchableOutputGroup", "");
    qmlRegisterType<Victron::VenusOS::SwitchableOutputGroupModel>("Victron.VenusOS", 2, 0, "SwitchableOutputGroupModel");
    ...
    return quick_test_main(argc, argv, "tst_switchableoutputgroupmodel", nullptr);
}
