...
public:
	...
	{
		return Victron::VenusOS::UiTestUtils::normalizeUiTestArguments(arguments);
	}
			...
			const QStringList &alreadyRecorded = QStringList()) const
	{
		...
		const int added = Victron::VenusOS::UiTestUtils::countNewRuntimeWarningTexts(
	...
	{
		return Victron::VenusOS::UiTestUtils::exitCodeForFailures(stepFailures, runtimeQmlErrors);
	}
