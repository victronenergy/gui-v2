...
Page {
	...
	VeQuickItem {
		id: ignoreAcIn2Item
		uid: root.bindPrefix + "/Ac/State/IgnoreAcIn2"
	}
	VeQuickItem {
		id: ignoreAcIn1Item
		uid: root.bindPrefix + "/Ac/State/IgnoreAcIn1"
	}
	...
	GradientListView {
		...
		model: DelegateComponentModel {
			...
			DelegateComponent {
				preferredVisible: ignoreAcIn1Item.valid && isMulti
				ListText {
					//% "AC input 1 ignored"
			...
			DelegateComponent {
				preferredVisible: ignoreAcIn2Item.valid && isMulti
				ListText {
					//% "AC input 2 ignored"
			...
			DelegateComponent {
				id: waitingForRelayTestDC
				dataItem: VeQuickItem { uid: root.bindPrefix + "/Devices/0/ExtendStatus/WaitingForRelayTest" }
				preferredVisible: waitingForRelayTestDC.dataItem.valid && isEssOrHub4 && isMulti
				ListNavigation {
					//% "ESS Relay test"
