	...
	GradientListView {
		model: ObjectModel {
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x01) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x02) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x08) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x10) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x20) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x1000) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x2000) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x4000) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x10000) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && (code.value & 0x20000) != 0
			}
			...
			ListTextItem {
				...
				allowed: code.isValid && code.value > 0
			}
		}
	}
}
