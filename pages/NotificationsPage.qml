...
Page {
	...
	Column {
		...
		Button {
			...
			property int currentCategory: Enums.ToastNotification_Category_Error
			property bool useShortText: false

			onClicked: {
				currentCategory = (currentCategory + 1)
				if (currentCategory > Enums.ToastNotification_Category_Error) {
					currentCategory = Enums.ToastNotification_Category_None
