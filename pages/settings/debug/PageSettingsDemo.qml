	...
	GradientListView {
		...
		model: ObjectModel {
			...
			ListItem {
				...
				caption.color: Theme.color_listItem_secondaryText
				caption.text: "This can wrap next to the content item, or be placed below the content item and stretch to the full item size. Click the orange button to toggle this size mode."
			}
