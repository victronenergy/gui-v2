	...
	GradientListView {
		model: ObjectModel {
			...
			ListSwitch {
				...
				caption.preferredVisible: !maxSystemAcInputCurrentSwitch.enabled
				caption.topPadding: 0
				caption.bottomPadding: 0
				caption.color: Theme.color_font_secondary
				//% "To use this feature, Grid metering must be set to External meter, and an up to date ESS assistant must be installed."
				caption.text: qsTrId("settings_ess_limit_ac_import_restrictions")
			}
			...
			ListSwitch {
				...
				caption.preferredVisible: !maxSystemAcExportCurrentSwitch.enabled
				caption.topPadding: 0
				caption.bottomPadding: 0
				caption.color: Theme.color_font_secondary
				//% "Grid metering must be set to External meter to use this feature."
				caption.text: qsTrId("settings_ess_limit_ac_export_restrictions")
			}
