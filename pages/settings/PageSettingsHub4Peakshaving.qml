...
Page {
	...
	GradientListView {
		model: DelegateComponentModel {
			...
			DelegateComponent {
				id: maxSystemAcInputCurrentSwitchDC
				property bool checked: systemAcInputLimit.value >= 0
				ListSwitch {
			...
			DelegateComponent {
				preferredVisible: maxSystemAcInputCurrentSwitchDC.preferredVisible && maxSystemAcInputCurrentSwitchDC.checked
				ListSpinBox {
			...
			DelegateComponent {
				id: maxSystemAcExportCurrentSwitchDC
				property bool checked: systemAcExportLimit.value >= 0
				ListSwitch {
			...
			DelegateComponent {
				preferredVisible: maxSystemAcExportCurrentSwitchDC.preferredVisible && maxSystemAcExportCurrentSwitchDC.checked
				ListSpinBox {
