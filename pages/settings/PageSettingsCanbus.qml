		...
		model: ObjectModel {
			ListRadioButtonGroup {
				function isReadOnly(profile) {
					...
					case Enums.CanBusConfig_ForcedVeCan:
						return profile !== Enums.CanBusProfile_Vecan
					case Enums.CanBusConfig_ForcedCanBusBms:
						return profile !== Enums.CanBusProfile_CanBms500
					default:
						return false
					}
				}
				...
				optionModel: [
					{
						...
						value: Enums.CanBusProfile_Disabled
					},
					{
						//% "VE.Can & Lynx Ion BMS (250 kbit/s)"
						display: qsTrId("settings_canbus_vecan_lynx_ion_bms"),
						value: Enums.CanBusProfile_Vecan,
						readOnly: isReadOnly(Enums.CanBusProfile_Vecan)
					},
					{
						//% "VE.Can & CAN-bus BMS (250 kbit/s)"
						display: qsTrId("settings_canbus_vecan_and_can_bus_bms"),
						value: Enums.CanBusProfile_VecanAndCanBms,
						readOnly: isReadOnly(Enums.CanBusProfile_VecanAndCanBms)
					},
					{
						//% "CAN-bus BMS (500 kbit/s)"
						display: qsTrId("settings_canbus_bms"),
						value: Enums.CanBusProfile_CanBms500,
						readOnly: isReadOnly(Enums.CanBusProfile_CanBms500)
					},
					{
						//% "Oceanvolt (250 kbit/s)"
						display: qsTrId("settings_oceanvolt"),
						value: Enums.CanBusProfile_Oceanvolt,
						readOnly: isReadOnly(Enums.CanBusProfile_Oceanvolt)
					},
					{
						//% "RV-C (250 kbit/s)"
						display: qsTrId("settings_rvc"),
						value: Enums.CanBusProfile_RvC,
						readOnly: isReadOnly(Enums.CanBusProfile_RvC)
					},
					{
						//% "Up, but no services (250 kbit/s)"
						display: qsTrId("settings_up_bu_no_services"),
						value: Enums.CanBusProfile_None250,
						readOnly: true
					}
				]
			}
			...
			ListSpinBox {
				...
				onSelectorAccepted: {
					...
					Global.showToastNotification(Enums.Notification_Info, qsTrId("settings_canbus_unique_id_wait"), 5000)
