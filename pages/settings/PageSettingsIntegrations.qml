				...
				Repeater {
					...
					delegate: SettingsListNavigation {
						...
						Switch {
							...
							checked: Customisations.enabledCustomisations.indexOf(switchNavigationItem.name) >= 0
							onClicked: Global._enabledCustomisations.toggleEnabled(switchNavigationItem.name)
						}
					}
				}
			}
