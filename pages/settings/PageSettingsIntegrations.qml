		...
		model: DelegateComponentModel {
			...
			DelegateComponent {
				...
				ListNavigation {
					...
					secondaryText: signalkItemDC.dataItem.valid && signalkItemDC.dataItem.value ? CommonWords.enabled : CommonWords.disabled
			...
			DelegateComponent {
				...
				ListNavigation {
					...
					secondaryText: {
						if (nodeRedModeItemDC.dataItem.value === VenusOS.NodeRed_Mode_Disabled) {
							return CommonWords.disabled
						} else if (nodeRedModeItemDC.dataItem.value === VenusOS.NodeRed_Mode_EnabledWithSafeMode) {
							return qsTrId("settings_large_enabled_safe_mode")
						} else if (nodeRedModeItemDC.dataItem.value === VenusOS.NodeRed_Mode_Enabled) {
