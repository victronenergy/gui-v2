...
Page {
	...
	GradientListView {
		...
		delegate: ListNavigation {
			...
			onClicked: Global.pageManager.pushPage("/pages/settings/PageSettingsFroniusInverter.qml",
					{ title: Qt.binding(function() { return menu.text }),
					  bindPrefix: menu.inverterPath })
