				...
				onClicked: {
					if (!checked) {
						if (!generatorIsSet) {
							...
							Global.showToastNotification(Enums.Notification_Info, qsTrId("page_settings_generator_detect_generator_not_set"),
							...
							Global.showToastNotification(Enums.Notification_Info, qsTrId("page_settings_generator_detect_generator_set"),
