	...
	GradientListView {
		model: VisibleItemModel {
			ListText {
				...
				dataItem.uid: Services.system.serviceUid + "/Control/VebusSoc"
			...
			ListText {
				...
				dataItem.uid: Services.system.serviceUid + "/Control/ExtraBatteryCurrent"
				secondaryText: CommonWords.onOrOff(dataItem.value)
			}
			...
			ListText {
				...
				dataItem.uid: Services.system.serviceUid + "/Control/SolarChargeVoltage"
				secondaryText: CommonWords.onOrOff(dataItem.value)
			}
			...
			ListText {
				...
				dataItem.uid: Services.system.serviceUid + "/Control/SolarChargeCurrent"
				secondaryText: CommonWords.onOrOff(dataItem.value)
			}
			...
			ListText {
				...
				dataItem.uid: Services.system.serviceUid + "/Control/BmsParameters"
				secondaryText: CommonWords.onOrOff(dataItem.value)
			}
		}
	}
