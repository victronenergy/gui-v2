...
Page {
	...
	VeQuickItem {
		id: uIAnimationsItem
		uid: Global.systemSettings.serviceUid + "/Settings/Gui2/UIAnimations"
	}
	...
	GradientListView {
		...
		model: DelegateComponentModel {
			...
			DelegateComponent {
				id: autoBrightnessDC
				dataItem: VeQuickItem { uid: Global.systemSettings.serviceUid + "/Settings/Gui/AutoBrightness" }
			...
			DelegateComponent {
				preferredVisible: !autoBrightnessDC.checked && Qt.platform.os != "wasm"
				ListSlider {
					//% "Brightness"
			...
			DelegateComponent {
				preferredVisible: uIAnimationsItem.valid
				ListSwitch {
