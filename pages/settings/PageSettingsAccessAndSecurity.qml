...
Page {
	...
	GradientListView {
		...
		model: DelegateComponentModel {
			...
			DelegateComponent {
				id: remoteSupportOnOffDC
				dataItem: VeQuickItem { uid: Global.systemSettings.serviceUid + "/Settings/System/RemoteSupport" }
			...
			DelegateComponent {
				preferredVisible: remoteSupportOnOffDC.checked
				ListText {
					//% "Remote support tunnel"
					text: qsTrId("settings_remote_support_tunnel")
					secondaryText: remotePortDC.dataItem.valid && String(remotePortDC.dataItem.value).length > 0
							   ? CommonWords.online
							   : CommonWords.offline
				}
			}
			...
			DelegateComponent {
				id: remotePortDC
				dataItem: VeQuickItem { uid: Global.systemSettings.serviceUid + "/Settings/System/RemoteSupportIpAndPort" }
				preferredVisible: remoteSupportOnOffDC.checked
				ListText {
					id: remotePort
			...
			DelegateComponent {
				preferredVisible: Qt.platform.os === "wasm"
					...
					&& securityProfileItem.value !== VenusOS.Security_Profile_Unsecured
				ListButton {
					//% "Logout"
