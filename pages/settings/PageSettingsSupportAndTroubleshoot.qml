					...
					Page {
						GradientListView {
							model: ObjectModel {
								...
								ListButton {
									//% ""
									text: "Check the warranty"
									//% ""
									button.text: "Open in a new tab"
									allowed: defaultAllowed && Qt.platform.os === "wasm"
									onClicked: BackendConnection.openUrl("https://www.victronenergy.com/support")
								}
								...
								ListItem {
									...
									content.children: [
										Image {
											source: "image://QZXing/encode/" + "https://www.victronenergy.com/support" +
													"?correctionLevel=M" +
													"&format=qrcode"
