...
class MockManager : public QObject
{
	...
	QML_ELEMENT
	QML_SINGLETON
	Q_PROPERTY(QString lastConfiguration READ lastConfiguration NOTIFY lastConfigurationChanged FINAL)

public:
	bool hasValues() const;
	QString lastConfiguration() const;
	...
	Q_INVOKABLE void removeAllValues();
	Q_INVOKABLE bool setValuesFromJson(const QString &fileName);

	// Clears all values and loads the specified configuration.
