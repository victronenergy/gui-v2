...
Enums::DcMeter_Type Enums::dcMeter_type(const QString &serviceType, int monitorMode) const
{
	...
	if (serviceType == "dcload") {
		switch (monitorMode) {
		case 8:
			return DcMeter_Type_WaterHeater;
		case 7:
			return DcMeter_Type_Inverter;
		case 5:
			return DcMeter_Type_BilgePump;
		case 4:
			return DcMeter_Type_WaterPump;
		case 3:
			return DcMeter_Type_Fridge;
		case 1:
		default:
			return DcMeter_Type_GenericLoad;
		}
	} else if (serviceType == "dcsource") {
		switch (monitorMode) {
		case -2:
			return DcMeter_Type_AcCharger;
		case -3:
			return DcMeter_Type_DcCharger;
		case -4:
			return DcMeter_Type_WaterGenerator;
		case -7:
			return DcMeter_Type_ShaftGenerator;
		case -8:
			return DcMeter_Type_WindCharger;
		case -1:
		default:
			return DcMeter_Type_GenericSource;
		}
	} else {
