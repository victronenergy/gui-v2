...
void registerQmlTypes()
{
	...
	qmlRegisterType(QUrl(QStringLiteral("qrc:/components/settings/PvInverterPositionRadioButtonGroup.qml")),
		"Victron.VenusOS", 2, 0, "PvInverterPositionRadioButtonGroup");
