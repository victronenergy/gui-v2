...
QtObject {
	...
	property var configs: [
		...
		},
		{
			...
			inputs: [
				{ customName: "Sensor A", temperature: 84.12, humidity: NaN },
				{ customName: "Sensor B", temperature: 45.3234, humidity: NaN },
				{ customName: "Sensor C", temperature: 83.1123, humidity: NaN },
				{ customName: "Sensor D", temperature: 100, humidity: NaN },
